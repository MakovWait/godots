...
static func editor_register_fonts(theme: Theme):
	...
	var default_font = load("res://fonts/NotoSans_Regular.woff2")
	var default_font_bold = load("res://fonts/NotoSans_Bold.woff2")
	var default_font_mono = load("res://fonts/JetBrainsMono_Regular.woff2")
